...
client_control = Flask(__name__)


@client_control.route('/')
def hello():
    return 'hello'


@client_control.route("/follow")
def follow():
    camera_flag = True
    count_lost = 0
...
if __name__ == '__main__':
    ...
    client_control.run(host="localhost", port=6354, debug=True)
