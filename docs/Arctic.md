...
Для признаков рада было реализовано два сенсора: GazeboLeaderPositionsTracker_v2 и GazeboLeaderPositionsCorridorLasers.
...
- saving_period = 3 - период сохрания точек маршрута ведущего
- 
